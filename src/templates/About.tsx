    ...
    <Stack spacing={5}>
        <Stack sx={{ flexDirection: {md: "row"}}}>
            <Stack spacing={40} sx={{width: "98%"}}>
                ...
                <Stack spacing={5}>
                <Box sx={{ fontSize: 25, width: "45%"}}>Through our artful animation and distinct design, we will infuse our dedicated passion for storytelling to align with your unique vision every step of the way.</Box>
                <Box sx={{ fontSize: 25, width: "45%"}}>Offering a full-service suite that spans original graphics, logos, animation, videos, web design, and brand consulting, we are a studio that produces content for you and most importantly, with you.</Box>
                </Stack>
            </Stack>
